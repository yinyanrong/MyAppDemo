...
public class FilteredDownloadManagerWrapper implements DownloadManager {
	...
	private boolean mDownloaded = false; // T=Filter downloaded files; F=Filter
											// downloading files
	private DownloadManager mManager;
	private HashMap<Integer, Integer> mElementsMap = new HashMap<Integer, Integer>();

	public FilteredDownloadManagerWrapper(DownloadManager manager,
			boolean filterDownloaded) {
		mManager = manager;
